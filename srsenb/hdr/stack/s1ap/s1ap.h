...
private:
  ...
  std::atomic<uint64_t> nas_ul_transport_initial_ue{0};
  std::atomic<uint64_t> nas_ul_transport_ul_nas{0};
  std::atomic<uint64_t> nas_dl_transport_dl_nas{0};
  std::atomic<uint64_t> nas_ul_sec_hdr_plain{0};
  std::atomic<uint64_t> nas_ul_sec_hdr_integrity{0};
  std::atomic<uint64_t> nas_ul_sec_hdr_integrity_ciphered{0};
  std::atomic<uint64_t> nas_ul_sec_hdr_integrity_new_ctx{0};
  std::atomic<uint64_t> nas_ul_sec_hdr_integrity_ciphered_new_ctx{0};
  std::atomic<uint64_t> nas_ul_sec_hdr_service_request{0};
  std::atomic<uint64_t> nas_ul_sec_hdr_unknown{0};
  std::atomic<uint64_t> nas_dl_sec_hdr_plain{0};
  std::atomic<uint64_t> nas_dl_sec_hdr_integrity{0};
  std::atomic<uint64_t> nas_dl_sec_hdr_integrity_ciphered{0};
  std::atomic<uint64_t> nas_dl_sec_hdr_integrity_new_ctx{0};
  std::atomic<uint64_t> nas_dl_sec_hdr_integrity_ciphered_new_ctx{0};
  std::atomic<uint64_t> nas_dl_sec_hdr_service_request{0};
  std::atomic<uint64_t> nas_dl_sec_hdr_unknown{0};
  std::atomic<uint64_t> nas_ul_pd_emm{0};
  std::atomic<uint64_t> nas_ul_pd_esm{0};
  std::atomic<uint64_t> nas_ul_pd_other{0};
  std::atomic<uint64_t> nas_dl_pd_emm{0};
  std::atomic<uint64_t> nas_dl_pd_esm{0};
  std::atomic<uint64_t> nas_dl_pd_other{0};
  std::atomic<uint32_t> nas_ul_pd_last{0};
  std::atomic<uint32_t> nas_dl_pd_last{0};
  std::atomic<uint64_t> nas_ul_short_pdu{0};
  std::atomic<uint64_t> nas_dl_short_pdu{0};
  std::atomic<uint64_t> nas_ul_parse_fail{0};
  std::atomic<uint64_t> nas_dl_parse_fail{0};
  std::atomic<uint64_t> nas_ul_attach{0};
  std::atomic<uint64_t> nas_dl_attach{0};
  std::atomic<uint64_t> nas_ul_tau{0};
  std::atomic<uint64_t> nas_dl_tau{0};
  std::atomic<uint64_t> nas_ul_service_request{0};
  std::atomic<uint64_t> nas_dl_service_request{0};
  std::atomic<uint64_t> nas_dl_service_reject{0};
  std::atomic<uint64_t> nas_ul_identity{0};
  std::atomic<uint64_t> nas_dl_identity{0};
  std::atomic<uint64_t> nas_ul_authentication{0};
  std::atomic<uint64_t> nas_dl_authentication{0};
  std::atomic<uint64_t> nas_ul_security_mode{0};
  std::atomic<uint64_t> nas_dl_security_mode{0};
  std::atomic<uint64_t> nas_ul_detach{0};
  std::atomic<uint64_t> nas_dl_detach{0};
  std::atomic<uint64_t> nas_ul_emm_status{0};
  std::atomic<uint64_t> nas_dl_emm_status{0};
  std::atomic<uint64_t> nas_ul_esm_information{0};
  std::atomic<uint64_t> nas_dl_esm_information{0};
  std::atomic<uint64_t> nas_ul_pdn_connectivity{0};
  std::atomic<uint64_t> nas_dl_pdn_connectivity{0};
  std::atomic<uint64_t> nas_ul_pdn_disconnect{0};
  std::atomic<uint64_t> nas_dl_pdn_disconnect{0};
  std::atomic<uint64_t> nas_ul_default_bearer{0};
  std::atomic<uint64_t> nas_dl_default_bearer{0};
  std::atomic<uint64_t> nas_ul_dedicated_bearer{0};
  std::atomic<uint64_t> nas_dl_dedicated_bearer{0};
  std::atomic<uint64_t> nas_ul_modify_bearer{0};
  std::atomic<uint64_t> nas_dl_modify_bearer{0};
  std::atomic<uint64_t> nas_ul_deactivate_bearer{0};
  std::atomic<uint64_t> nas_dl_deactivate_bearer{0};
  std::atomic<uint64_t> nas_ul_bearer_resource{0};
  std::atomic<uint64_t> nas_dl_bearer_resource{0};
  std::atomic<uint64_t> nas_ul_generic_transport{0};
  std::atomic<uint64_t> nas_dl_generic_transport{0};
  std::atomic<uint64_t> nas_dl_cs_service_notification{0};
  std::atomic<uint64_t> nas_ul_other{0};
  std::atomic<uint64_t> nas_dl_other{0};
  std::atomic<uint64_t> nas_ul_unknown{0};
  std::atomic<uint64_t> nas_dl_unknown{0};

  enum class nas_transport_t : uint8_t { initial_ue, ul_nas_transport, dl_nas_transport };
  void update_nas_l3_counters(const uint8_t* data, uint32_t len, bool is_uplink, nas_transport_t transport);
